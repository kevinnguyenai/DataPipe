...
# DataPipe Application

## from django-react-boilerplate under vinta-soft

## Web Application control the data pipe and implement realtime data analytic with visual desktop dashboard view of processing data
...
- [ ] Add an email address to the `ADMINS` settings variable in `DataPipe/DataPipe/settings/base.py`
...
- Create a copy of ``DataPipe/settings/local.py.example``:  
  `cp DataPipe/settings/local.py.example DataPipe/settings/local.py` (remembering you should replace `DataPipe` with your project's name!).
